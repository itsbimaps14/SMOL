...
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header">Permintaan User</h1>
<?php
...
<?php
echo anchor('produksi/permintaan/form','Tambah','class="btn btn-primary"');
?>
<br>
<br>
<div class="dataTable_wrapper">
	<table id="table-permintaan-produksi" class="table table-bordered table-hover dt-responsive nowrap" cellspacing="0" width="100%">
		<thead>
			<tr>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		//datatables
		table = $('#table-permintaan-produksi').DataTable({
			"responsive": true,
			...
			"ajax": {
				"url": '<?php echo site_url('produksi/json');?>',
				"type": "POST",
				"dataType": "json"
			},
			"columnDefs": [{
