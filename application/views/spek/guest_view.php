...
<div class="row">
	<div class="col-md-12">
		<table id="table_view_spek" class="table table-bordered table-hover dt-responsive datatable" cellspacing="0" width="100%">
			<thead>
				<tr>
					<th>#</th>
					<th>No. DB Spek</th>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		//datatables
		table = $('#table_view_spek').DataTable({
			...
			"ajax": {
				"url": '<?php echo site_url('spek/table_view_spek');?>',
				"type": "POST",
				"dataType": "json"
			},
			"columnDefs": [
