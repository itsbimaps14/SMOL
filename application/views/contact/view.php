...
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header">Data Contact E-Mail</h1>
<?php
...
<?php
echo anchor('contact/add','Tambah','class="btn btn-primary"');
?>
<br>
<br>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		table = $('#table-user').DataTable({
			...
			"ajax": {
				"url": '<?php echo site_url('contact/json');?>',
				"type": "POST",
				"dataType": "json"
			},
			"columnDefs": [{
