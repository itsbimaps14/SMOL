...
class reject_monitoring extends CI_Controller {

	var $folder = 'reject_monitoring';
	...
	public function index(){
		...
		switch ($plant) {
			case 'All':
				$data['read'] = $this->model_qc->view_qc('(status_qc = "OK" OR status_qc = "Released Partial") AND status_all = "Reject"');
			break;
			default:
				$data['read'] = $this->model_qc->view_qc('(status_qc = "OK" OR status_qc = "Released Partial") AND plant = "'.$plant.'" AND status_all = "Reject"');
			break;
		}
		$this->template->load('nav_head','qc/'.$this->folder.'/qc_reject_monitoring_view',$data);
	}
...
/* End of file reject_minitoring.php */
/* Location: ./application/controllers/qc/reject_minitoring.php */