...
class ok_bersyarat extends CI_Controller {

	var $folder = 'ok_bersyarat';
	...
	public function index(){
		...
		switch ($plant) {
			case 'All':
				$data['read'] = $this->model_qc->view_qc('status_all = "OK Bersyarat"');
			break;
			default:
				$data['read'] = $this->model_qc->view_qc('plant = "'.$plant.'" AND status_all = "OK Bersyarat"');
			break;
		}
		$this->template->load('nav_head','qc/'.$this->folder.'/qc_ok_bersyarat_view',$data);
	}
...
/* End of file ok_bersyarat.php */
/* Location: ./application/controllers/qc/ok_bersyarat.php */